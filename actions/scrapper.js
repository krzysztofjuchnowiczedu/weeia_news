...
Scrapper.prototype.getFacultyWebsiteContent = new Promise(
        ...
        if (!error) {
          ...
          $('.News').find('.Content').find('.Item').each(function (i, elem) {
            ...
            if (date) {
              ...
              news.date = new Date().toISOString().substring(0, 10);
            }
          ...
          $('.Komunikaty').find('.Content').find('.Item').each(
              function (i, elem) {
                var news = new News();
                var data = $(this);
                var date = data.find('.Date').text();
...
Scrapper.prototype.getUniversityWebsiteContent = new Promise(
    function (resolve, reject) {
...
Scrapper.prototype.getUniversityStudentsGovernmentWebsiteContent = new Promise(
    function (resolve, reject) {
